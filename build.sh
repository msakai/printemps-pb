...
(cd src/toysolver && stack build --flag toysolver:optparse-applicative-018 --flag toysolver:ForceChar8 --flag toysolver:-BuildForeignLibraries && cp $(stack path --dist-dir)/build/toyconvert/toyconvert ../../bin)
